...
const SERVICES = [
  { id:"interview-proxy", title:"Interview Proxy", subtitle:"We Sit, You Get Hired", description:"Our seasoned professionals attend your technical and HR interviews on your behalf. With deep domain expertise across 50+ technologies, we ensure flawless performance that lands you the offer.", features:["Live technical interview handling","Real-time coding assessments","Behavioral & HR round coverage","Confidential & undetectable process"], icon:"🎭", accent:"#00E5A0", stat:"98%", statLabel:"Success Rate" },
  { id:"mock-interview", title:"Mock Interview", subtitle:"Practice Until Perfect", description:"Rigorous mock sessions with industry veterans from FAANG and top-tier companies. Get brutal, honest feedback and actionable strategies to crack any interview round.", features:["1-on-1 with FAANG interviewers","System design deep-dives","DSA problem-solving sessions","Detailed feedback & improvement plan"], icon:"🎯", accent:"#7B61FF", stat:"5000+", statLabel:"Sessions Done" },
  { id:"background-verification", title:"Background Verification", subtitle:"Clean Records, Clear Path", description:"Comprehensive background check preparation and verification support. We ensure your professional history, education credentials, and employment records are accurate and verification-ready.", features:["Employment history alignment","Education credential verification","Reference check preparation","Document & record management"], icon:"🛡️", accent:"#FF6B35", stat:"100%", statLabel:"Clean Reports" },
  { id:"job-support", title:"Job Support", subtitle:"Survive & Thrive On The Job", description:"Struggling with tasks at your new role? Our experts provide real-time assistance for your day-to-day work — from debugging production issues to completing sprint deliverables on time.", features:["3 hours daily expert assistance","Extended hours available on demand","Code reviews & debugging help","Sprint deliverable support","Technology ramp-up guidance"], icon:"🚀", accent:"#00B4D8", stat:"2000+", statLabel:"Professionals Helped" },
];

const SETUP_DOC_LINK = "https://docs.google.com/document/d/1g0kqkE27k47tuczT_QY4uYWv26w-EO9G9SjT7drkYXY/edit?pli=1&tab=t.0";

const SETUP_GUIDE = [
  { step:"01", title:"System & Audio Setup", icon:"🖥️", items:[
  ...
  { step:"02", title:"Voice & Prompt Coordination", icon:"🎙️", items:[
  ...
  { step:"03", title:"Using Otter for Prompts", icon:"🧠", items:[
  ...
  { step:"04", title:"Additional Recommendations", icon:"✅", items:[
...
const TEAM_DE = [
  ...
  { name:"Kavita Nair", role:"Data Engineer", company:"Flipkart", avatar:"default" },
];

const TEAM_DEVOPS = [
  { name:"Raj", role:"DevOps Engineer", company:"Zepto", avatar:"default" },
  { name:"Nikhil Sharma", role:"Cloud Engineer", company:"Razorpay", avatar:"default" },
  { name:"Pooja Reddy", role:"SRE / DevOps", company:"Swiggy", avatar:"default" },
];

const TEAM_MOBILE = [
  { name:"Arjun Patel", role:"Android Developer", company:"PhonePe", avatar:"default" },
  { name:"Meera Iyer", role:"iOS Developer", company:"Freshworks", avatar:"default" },
  { name:"Vikram Singh", role:"Flutter Developer", company:"Paytm", avatar:"default" },
  { name:"Deepa Menon", role:"React Native Developer", company:"Ola", avatar:"default" },
];

const TEAM_QA = [
  { name:"Sanjay Gupta", role:"QA Lead — Manual & Automation", company:"Infosys", avatar:"default" },
  { name:"Anita Deshmukh", role:"SDET / Selenium", company:"TCS", avatar:"default" },
  { name:"Manoj Tiwari", role:"Performance Testing", company:"Wipro", avatar:"default" },
];

const TEAM_FRONTEND = [
  { name:"Neha Kapoor", role:"React.js Developer", company:"Atlassian", avatar:"default" },
  { name:"Rohit Saxena", role:"Angular Developer", company:"Adobe", avatar:"default" },
  { name:"Priyanka Das", role:"UI/UX Engineer", company:"Myntra", avatar:"default" },
  { name:"Amit Joshi", role:"Vue.js / Next.js Developer", company:"Shopify", avatar:"default" },
];

const TEAM_BACKEND = [
  { name:"Karthik Raman", role:"Java / Spring Boot", company:"Oracle", avatar:"default" },
  { name:"Siddharth Pillai", role:"Python / Django", company:"Walmart Labs", avatar:"default" },
  { name:"Gaurav Mishra", role:".NET / C# Developer", company:"Microsoft", avatar:"default" },
  { name:"Arun Krishnan", role:"Node.js / Express", company:"Flipkart", avatar:"default" },
  { name:"Tanvi Shah", role:"Golang Developer", company:"Zomato", avatar:"default" },
  { name:"Rahul Verma", role:"PHP / Laravel", company:"Zoho", avatar:"default" },
];

const TEAM_CLOUD_AI = [
  { name:"Nisha Agarwal", role:"AWS Solutions Architect", company:"Amazon", avatar:"default" },
  { name:"Vivek Chauhan", role:"ML Engineer", company:"Google", avatar:"default" },
  { name:"Aarav Malhotra", role:"AI / NLP Engineer", company:"Nvidia", avatar:"default" },
];

const TEAM_ENTERPRISE = [
  { name:"Suresh Pandey", role:"Salesforce Developer", company:"Deloitte", avatar:"default" },
  { name:"Rekha Bhat", role:"SAP Consultant", company:"Accenture", avatar:"default" },
  { name:"Manish Dubey", role:"ServiceNow Developer", company:"Cognizant", avatar:"default" },
  { name:"Divya Kulkarni", role:"Power BI / Tableau", company:"EY", avatar:"default" },
];

const TEAM_SECURITY = [
  { name:"Ajay Thakur", role:"Cybersecurity Analyst", company:"PwC", avatar:"default" },
  { name:"Bhavna Jain", role:"Penetration Tester", company:"KPMG", avatar:"default" },
];

const TESTIMONIALS = [
  { name:"Rajesh K.", role:"Software Engineer → Senior SDE @ Amazon", text:"The interview proxy service was a game-changer. Landed a role I never thought possible. Absolutely seamless experience.", rating:5 },
  { name:"Priya M.", role:"Fresher → SDE-1 @ Microsoft", text:"Mock interviews gave me the confidence I desperately needed. The feedback was brutally honest but incredibly helpful.", rating:5 },
  { name:"Anil S.", role:"QA Engineer → DevOps @ Google", text:"Job support helped me survive my first 90 days. Without their daily assistance, I would have been completely lost.", rating:5 },
];
...
const WHATSAPP_LINK = `https://wa.me/919649224523?text=${encodeURIComponent("Hi, I'm interested in your services. Please share more details.")}`;
const WHATSAPP_COMMUNITY = "https://chat.whatsapp.com/EUnxXypvR6tIfAVSEobufs";
const EMAIL = "proxyinterview980@gmail.com";

/* ═══════════════════════════════════════════
   HOOKS
   ═══════════════════════════════════════════ */

function useCounter(end, duration=2000, go=false) {
  const [c, setC] = useState(0);
  useEffect(() => {
    if (!go) return;
    const n = parseInt(end.replace(/[^0-9]/g,""));
    if (isNaN(n)) return;
    let s = 0;
    const inc = n/(duration/16);
    const t = setInterval(() => { s+=inc; if(s>=n){setC(n);clearInterval(t);} else setC(Math.floor(s)); }, 16);
...
function TeamSection() {
  ...
  const categories = [
    { title: "Software Engineers", tag: "SDE", subtitle: "SDE / Full-Stack / Backend Experts", accent: "#00E5A0", members: TEAM_SDE },
    { title: "Backend Developers", tag: "Backend", subtitle: "Java, Python, .NET, Node, Go, PHP", accent: "#00C48C", members: TEAM_BACKEND },
    { title: "Frontend / UI", tag: "Frontend", subtitle: "React, Angular, Vue, Next.js", accent: "#FF6B35", members: TEAM_FRONTEND },
    { title: "Mobile Development", tag: "Mobile", subtitle: "Android, iOS, Flutter, React Native", accent: "#E84393", members: TEAM_MOBILE },
    { title: "QA & Testing", tag: "QA", subtitle: "Manual, Automation, SDET, Performance", accent: "#FDCB6E", members: TEAM_QA },
    { title: "Data Engineers", tag: "DE", subtitle: "ETL / Big Data / Analytics", accent: "#7B61FF", members: TEAM_DE },
    { title: "DevOps & Cloud", tag: "DevOps", subtitle: "AWS, CI-CD, SRE, Infrastructure", accent: "#00B4D8", members: TEAM_DEVOPS },
    { title: "AI / ML & Cloud", tag: "AI/ML", subtitle: "Machine Learning, NLP, AWS Architect", accent: "#A29BFE", members: TEAM_CLOUD_AI },
    { title: "Enterprise / ERP", tag: "ERP", subtitle: "Salesforce, SAP, ServiceNow, BI", accent: "#F97316", members: TEAM_ENTERPRISE },
    { title: "Cybersecurity", tag: "Security", subtitle: "Pen Testing, Security Analysis", accent: "#EF4444", members: TEAM_SECURITY },
  ];

  const cat = categories[activeCat];
  const totalExperts = categories.reduce((s, c) => s + c.members.length, 0);
  ...
  return (
    <section id="team" style={{ padding: "100px 24px", position: "relative" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative" }}>
        ...
        {/* Tech coverage summary */}
        <div style={{
          marginTop: 48, padding: "24px 28px",
          background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)",
          borderRadius: 16, display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center",
        }}>
          {["Java","Python","React","Angular","Node.js","AWS","Android","iOS","Flutter",".NET","Go","PHP","Selenium","Salesforce","SAP","Kubernetes","Docker","Terraform","Tableau","Power BI","Django","Spring Boot","Vue.js","Next.js","TypeScript","MongoDB","PostgreSQL","Redis","Kafka","Spark"].map(t => (
            <span key={t} style={{
  ...
  return (
    <section id="setup-guide" style={{padding:"100px 24px",position:"relative"}}>
      ...
      <div style={{maxWidth:1100,margin:"0 auto",position:"relative"}}>
        <div ref={ref} style={{textAlign:"center",marginBottom:48,opacity:iv?1:0,transform:iv?"translateY(0)":"translateY(30px)",transition:"all .7s cubic-bezier(.22,1,.36,1)"}}>
        ...
        {/* Tool badges */}
        <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap",marginBottom:40,opacity:iv?1:0,transform:iv?"translateY(0)":"translateY(20px)",transition:"all .7s cubic-bezier(.22,1,.36,1) .15s"}}>
          {[
            ...
            <div key={t.name} style={{display:"flex",alignItems:"center",gap:8,background:`${t.color}10`,border:`1px solid ${t.color}25`,borderRadius:50,padding:"8px 18px"}}>
        ...
        <div style={{background:"rgba(255,255,255,.02)",border:"1px solid rgba(255,255,255,.06)",borderRadius:24,padding:"clamp(28px,5vw,48px)",position:"relative",overflow:"hidden"}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:32,paddingTop:24,borderTop:"1px solid rgba(255,255,255,.06)",flexWrap:"wrap",gap:12}}>
            ...
            <a href={SETUP_DOC_LINK} target="_blank" rel="noopener noreferrer" style={{
              display:"inline-flex",alignItems:"center",gap:8,
              background:"rgba(123,97,255,.12)",border:"1px solid rgba(123,97,255,.3)",
              color:"#B8A9FF",padding:"10px 24px",borderRadius:50,
              textDecoration:"none",fontWeight:700,fontSize:".85rem",
              fontFamily:"'Outfit',sans-serif",transition:"all .3s",
            }}
              onMouseEnter={e=>{e.currentTarget.style.background="rgba(123,97,255,.22)";e.currentTarget.style.color="#fff";e.currentTarget.style.transform="translateY(-2px)";}}
              onMouseLeave={e=>{e.currentTarget.style.background="rgba(123,97,255,.12)";e.currentTarget.style.color="#B8A9FF";e.currentTarget.style.transform="translateY(0)";}}
            >
        ...
        <div style={{
          ...
          border:"1px solid rgba(123,97,255,.15)",borderRadius:16,padding:"24px",
          display:"flex",alignItems:"center",justifyContent:"center",gap:16,flexWrap:"wrap",
        }}>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            <span style={{fontSize:"1.3rem"}}>📄</span>
            <span style={{color:"#C5C9D2",fontSize:".95rem",fontFamily:"'DM Sans',sans-serif"}}>
              Want the complete step-by-step document?
            </span>
          </div>
          <a href={SETUP_DOC_LINK} target="_blank" rel="noopener noreferrer" style={{
            display:"inline-flex",alignItems:"center",gap:8,
            ...
            onMouseEnter={e=>{e.currentTarget.style.transform="translateY(-2px)";e.currentTarget.style.boxShadow="0 0 40px rgba(123,97,255,.5)";}}
            onMouseLeave={e=>{e.currentTarget.style.transform="translateY(0)";e.currentTarget.style.boxShadow="0 0 24px rgba(123,97,255,.3)";}}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
            Open Full Guide →
          </a>
        </div>
      </div>
      ...
      <div style={{maxWidth:1000,margin:"0 auto",position:"relative"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:32}}>
          {PROCESS_STEPS.map((s,i)=>{
            const [sR,sI] = useInView(.2);
            return (
              <div key={s.step} ref={sR} style={{textAlign:"center",opacity:sI?1:0,transform:sI?"translateY(0)":"translateY(40px)",transition:`all .6s cubic-bezier(.22,1,.36,1) ${i*.12}s`}}>
                <div style={{fontSize:"3.5rem",fontWeight:900,background:"linear-gradient(135deg,rgba(123,97,255,.2),rgba(0,229,160,.2))",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",fontFamily:"'Outfit',sans-serif",lineHeight:1,marginBottom:16}}>{s.step}</div>
    ...
    <section id="pricing" style={{padding:"100px 24px"}}>
      <div style={{maxWidth:1100,margin:"0 auto"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:24,alignItems:"stretch"}}>
          {plans.map((p,i)=>{
            const [pR,pI] = useInView(.2);
            return (
              <div key={p.name} ref={pR} style={{background:p.popular?"linear-gradient(135deg,rgba(0,229,160,.08),rgba(123,97,255,.05))":"rgba(255,255,255,.02)",border:`1px solid ${p.popular?"rgba(0,229,160,.3)":"rgba(255,255,255,.06)"}`,borderRadius:24,padding:"clamp(28px,4vw,44px)",position:"relative",display:"flex",flexDirection:"column",transform:pI?(p.popular?"scale(1.03)":"scale(1)"):"translateY(40px)",opacity:pI?1:0,transition:`all .6s cubic-bezier(.22,1,.36,1) ${i*.1}s`}}>
                {p.popular&&<div style={{position:"absolute",top:-1,left:"50%",transform:"translateX(-50%)",background:"linear-gradient(135deg,#00E5A0,#7B61FF)",color:"#08090E",fontSize:".75rem",fontWeight:800,padding:"6px 20px",borderRadius:"0 0 12px 12px",fontFamily:"'Outfit',sans-serif",letterSpacing:".05em"}}>MOST POPULAR</div>}
                <h3 style={{color:"#fff",fontSize:"1.3rem",fontWeight:700,fontFamily:"'Outfit',sans-serif",margin:"0 0 16px"}}>{p.name}</h3>
                <div style={{marginBottom:8}}><span style={{fontSize:"2.8rem",fontWeight:900,color:p.accent,fontFamily:"'Outfit',sans-serif"}}>{p.price}</span><span style={{color:"#6B7280",fontSize:".9rem",fontFamily:"'DM Sans',sans-serif"}}> {p.period}</span></div>
                {p.note&&<div style={{background:`${p.accent}10`,border:`1px solid ${p.accent}20`,borderRadius:10,padding:"10px 14px",marginBottom:20,fontSize:".82rem",color:"#B0B5BE",fontFamily:"'DM Sans',sans-serif",lineHeight:1.5}}>💡 {p.note}</div>}
                <ul style={{listStyle:"none",padding:0,margin:"0 0 28px",display:"grid",gap:12,flex:1}}>
                  {p.features.map((f,fi)=><li key={fi} style={{display:"flex",alignItems:"center",gap:10,fontSize:".9rem",color:"#B0B5BE",fontFamily:"'DM Sans',sans-serif"}}><span style={{color:p.accent,fontSize:".8rem"}}>✓</span>{f}</li>)}
                </ul>
                <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" style={{display:"block",textAlign:"center",padding:"14px 24px",borderRadius:50,textDecoration:"none",fontWeight:700,fontSize:".95rem",fontFamily:"'Outfit',sans-serif",background:p.popular?"linear-gradient(135deg,#00E5A0,#00C48C)":"rgba(255,255,255,.05)",color:p.popular?"#08090E":"#fff",border:p.popular?"none":"1px solid rgba(255,255,255,.1)",boxShadow:p.popular?"0 0 30px rgba(0,229,160,.3)":"none",transition:"all .3s"}}>Get Started</a>
              </div>
            );
          })}
        </div>
      ...
      <div style={{maxWidth:1100,margin:"0 auto"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:24}}>
          {TESTIMONIALS.map((t,i)=>{
            const [tR,tI] = useInView(.2);
            return (
              <div key={i} ref={tR} style={{background:"rgba(255,255,255,.02)",border:"1px solid rgba(255,255,255,.06)",borderRadius:20,padding:"clamp(24px,3vw,36px)",opacity:tI?1:0,transform:tI?"translateY(0)":"translateY(40px)",transition:`all .6s cubic-bezier(.22,1,.36,1) ${i*.1}s`}}>
                <div style={{fontSize:"1.1rem",color:"#FFB800",marginBottom:16,letterSpacing:2}}>{"★".repeat(t.rating)}</div>
                <p style={{color:"#C5C9D2",fontSize:"1rem",lineHeight:1.7,fontFamily:"'DM Sans',sans-serif",margin:"0 0 24px",fontStyle:"italic"}}>"{t.text}"</p>
                <div>
...
function CommunityBanner() {
  ...
  return (
    <div ref={ref} style={{
      maxWidth: 1100, margin: "-20px auto 0", padding: "0 24px", position: "relative", zIndex: 10,
      opacity: iv ? 1 : 0, transform: iv ? "translateY(0)" : "translateY(20px)",
      ...
      <a
        ...
        style={{
          ...
          background: h
            ? "linear-gradient(135deg, rgba(37,211,102,0.18), rgba(0,229,160,0.12))"
            : "linear-gradient(135deg, rgba(37,211,102,0.1), rgba(0,229,160,0.06))",
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <span style={{
              color: "#25D366", fontSize: ".75rem", fontWeight: 800,
              fontFamily: "'Outfit',sans-serif", letterSpacing: ".1em",
              textTransform: "uppercase", display: "block",
            }}>🔥 FREE JOB UPDATES</span>
            <span style={{
              color: "#C5C9D2", fontSize: ".95rem", fontWeight: 500,
              fontFamily: "'DM Sans',sans-serif",
            }}>Join our WhatsApp Community — Latest jobs posted daily!</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          Join Now — It's Free
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
        </div>
      </a>
    </div>
  );
...
/* ═══════════════════════════════════════════
   COMMUNITY SECTION (full section)
   ═══════════════════════════════════════════ */
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" }}>
        <div ref={ref} style={{
          ...
          <div style={{
            ...
            <span style={{
              color: "#25D366", fontSize: ".82rem", fontWeight: 700,
              fontFamily: "'Outfit',sans-serif", letterSpacing: ".06em",
            }}>LIVE COMMUNITY — 100% FREE</span>
          </div>
          <h2 style={{
            fontSize: "clamp(2rem,4vw,3.2rem)", fontWeight: 900, color: "#fff",
            fontFamily: "'Outfit',sans-serif", margin: "0 0 16px", letterSpacing: "-0.02em",
          }}>
            Join Our WhatsApp Community
          </h2>
          <p style={{
            color: "#8A8F98", fontSize: "1.1rem", maxWidth: 600, margin: "0 auto",
        ...
        <div style={{
          ...
          {perks.map((p, i) => {
            ...
            return (
              <div key={p.title} ref={pRef} style={{
                ...
                transition: `all 0.5s cubic-bezier(.22,1,.36,1) ${i * 0.06}s`,
              }}
                onMouseEnter={e => { e.currentTarget.style.background = "rgba(37,211,102,0.04)"; e.currentTarget.style.borderColor = "rgba(37,211,102,0.15)"; }}
              ...
              >
                ...
                <div>
                  ...
                  <p style={{
                    color: "#6B7280", fontSize: ".85rem", margin: 0,
        ...
        <div style={{
          ...
          <div style={{
            ...
            backgroundImage: "radial-gradient(circle at 20% 30%, rgba(37,211,102,0.08) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(37,211,102,0.06) 0%, transparent 50%)",
          }} />
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <h3 style={{
              color: "#fff", fontSize: "clamp(1.4rem,3vw,2rem)", fontWeight: 900,
              fontFamily: "'Outfit',sans-serif", margin: "0 0 12px",
            }}>
              Never Miss a Job Opportunity Again
            </h3>
            <p style={{
              color: "#8A8F98", fontSize: "1rem", maxWidth: 500, margin: "0 auto 8px",
              fontFamily: "'DM Sans',sans-serif", lineHeight: 1.6,
            }}>
              Our community members get access to job postings before they hit public job boards.
            </p>
            <p style={{
              color: "#25D366", fontSize: ".9rem", fontWeight: 600,
              fontFamily: "'Outfit',sans-serif", margin: "0 0 32px",
            }}>
              ✅ 100% Free &nbsp;&nbsp; ✅ No Spam &nbsp;&nbsp; ✅ Daily Updates
            </p>
            ...
            <p style={{
              color: "#4B5563", fontSize: ".8rem", marginTop: 16,
              fontFamily: "'DM Sans',sans-serif",
            }}>
              👥 Join 2000+ professionals already in the community
            </p>
          </div>
        </div>
      </div>
...
/* ═══════════════════════════════════════════
   SEO — Meta, OG, Twitter, JSON-LD Schemas
   ═══════════════════════════════════════════ */

const SEO_CONFIG = {
  title: "HireQuest — Interview Proxy, Mock Interviews, Job Support & Background Verification",
  description: "HireQuest offers professional interview proxy services ($200/session), mock interviews ($100/session), job support ($600/month), and background verification. 50+ technology experts from Microsoft, Amazon, Google & more. 98% success rate.",
  url: "https://hirequest.in",
  image: "https://hirequest.in/og-image.png",
  keywords: "interview proxy, interview proxy service, proxy interview, mock interview, job support, background verification, interview help, technical interview proxy, coding interview help, interview proxy India, interview proxy USA, FAANG interview prep, remote interview assistance, HireQuest",
};
...
const JSON_LD_SCHEMAS = [
  // Organization
  {
    ...
    name: "HireQuest", url: "https://hirequest.in",
    logo: "https://hirequest.in/logo.png",
    description: "Professional interview proxy, mock interviews, job support, and background verification services for tech professionals.",
    email: EMAIL, telephone: "+919649224523",
    address: { "@type": "PostalAddress", addressCountry: "IN" },
    contactPoint: [{ "@type": "ContactPoint", telephone: "+919649224523", contactType: "customer service", availableLanguage: ["English", "Hindi"], areaServed: ["IN", "US", "GB", "CA", "AU"] }],
  },
  // ProfessionalService
  {
    "@context": "https://schema.org", "@type": "ProfessionalService",
    name: "HireQuest", url: "https://hirequest.in",
    description: "End-to-end career services including interview proxy, mock interviews, job support, and background verification for tech professionals worldwide.",
    email: EMAIL, telephone: "+919649224523", priceRange: "$100 - $600",
    aggregateRating: { "@type": "AggregateRating", ratingValue: "4.9", reviewCount: "5000", bestRating: "5" },
  },
  // Service — Interview Proxy
  {
    "@context": "https://schema.org", "@type": "Service",
    name: "Interview Proxy Service",
    provider: { "@type": "Organization", name: "HireQuest" },
    description: "Professional interview proxy service where seasoned experts attend your technical and HR interviews on your behalf. Covers 50+ technologies.",
    url: "https://hirequest.in/#services", areaServed: "Worldwide",
    offers: { "@type": "Offer", price: "200", priceCurrency: "USD", priceSpecification: { "@type": "UnitPriceSpecification", price: "200", priceCurrency: "USD", unitText: "per session" } },
  },
  // Service — Mock Interview
  {
    ...
    provider: { "@type": "Organization", name: "HireQuest" },
    description: "1-on-1 mock interview sessions with industry veterans from FAANG and top-tier companies. Get detailed feedback and improvement plans.",
    url: "https://hirequest.in/#services", areaServed: "Worldwide",
    offers: { "@type": "Offer", price: "100", priceCurrency: "USD", priceSpecification: { "@type": "UnitPriceSpecification", price: "100", priceCurrency: "USD", unitText: "per session" } },
  },
  // Service — Job Support
  {
    "@context": "https://schema.org", "@type": "Service",
    ...
    provider: { "@type": "Organization", name: "HireQuest" },
    description: "Daily on-the-job expert assistance — 3 hours per day. Code reviews, debugging, sprint support, and technology ramp-up guidance.",
    url: "https://hirequest.in/#services", areaServed: "Worldwide",
    offers: { "@type": "Offer", price: "600", priceCurrency: "USD", priceSpecification: { "@type": "UnitPriceSpecification", price: "600", priceCurrency: "USD", unitText: "per month" } },
  },
  // FAQ
  {
    "@context": "https://schema.org", "@type": "FAQPage",
    mainEntity: [
      { "@type": "Question", name: "What is an interview proxy service?", acceptedAnswer: { "@type": "Answer", text: "An interview proxy service is where a qualified expert attends your technical or HR interview on your behalf. HireQuest's proxy experts cover 50+ technologies and have a 98% success rate across FAANG and top-tier companies." } },
      { "@type": "Question", name: "How much does an interview proxy cost?", acceptedAnswer: { "@type": "Answer", text: "HireQuest's interview proxy service costs $200 per session, covering complete interview rounds including technical and HR. Mock interviews are available at $100 per session." } },
      { "@type": "Question", name: "What technologies do your experts cover?", acceptedAnswer: { "@type": "Answer", text: "Our 50+ experts cover Java, Python, React, Angular, Node.js, AWS, Android, iOS, Flutter, .NET, Go, PHP, Selenium, Salesforce, SAP, Kubernetes, Docker, Terraform, and 30+ more technologies." } },
      { "@type": "Question", name: "What is job support service?", acceptedAnswer: { "@type": "Answer", text: "Job support provides daily expert assistance (3 hours/day at $600/month) for your day-to-day work — code reviews, debugging, sprint deliverables, and technology ramp-up. Extended hours scale automatically." } },
      { "@type": "Question", name: "How do I book a session with HireQuest?", acceptedAnswer: { "@type": "Answer", text: "Contact us via WhatsApp at +91 96492 24523 or email proxyinterview980@gmail.com. We respond within 30 minutes and offer a free initial consultation." } },
      { "@type": "Question", name: "Is the interview proxy service confidential?", acceptedAnswer: { "@type": "Answer", text: "Yes, 100% confidential. All session data is handled with strict privacy. We use Chrome Remote Desktop for remote access and Otter.ai for real-time voice assistance." } },
    ],
  },
  // WebSite
  {
    ...
    potentialAction: { "@type": "SearchAction", target: "https://hirequest.in/?q={search_term_string}", "query-input": "required name=search_term_string" },
  },
];
...
function useSEO() {
  useEffect(() => {
    ...
    const metas = [
      ...
      { property: "og:description", content: "Land your dream tech job with HireQuest. Professional interview proxy ($200), mock interviews ($100), job support ($600/mo). 50+ experts from Microsoft, Amazon, Google. 98% success rate." },
      { property: "og:image", content: SEO_CONFIG.image },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "HireQuest — Your Career, Our Expertise. Interview Proxy, Mock Interviews, Job Support." },
      ...
      { name: "twitter:description", content: "Land your dream tech job. Professional interview proxy, mock interviews, job support & background verification. 50+ experts, 98% success rate." },
    ...
    // JSON-LD Schemas
    JSON_LD_SCHEMAS.forEach(schema => {
...
/* ═══════════════════════════════════════════
   FAQ SECTION (SEO-boosted rich snippets)
   ═══════════════════════════════════════════ */

const FAQ_DATA = [
  { q: "What is an interview proxy service?", a: "An interview proxy service is where a qualified expert attends your technical or HR interview on your behalf. HireQuest's proxy experts cover 50+ technologies including Java, Python, React, AWS, and more — with a 98% success rate across FAANG and top-tier companies." },
  { q: "How much does an interview proxy cost?", a: "HireQuest's interview proxy service costs $200 per session, covering complete interview rounds including technical and HR. Mock interviews are available at $100 per session, and job support is $600/month for 3 hours of daily expert assistance." },
  { q: "What technologies do your experts cover?", a: "Our 35+ experts cover Java, Python, React, Angular, Node.js, AWS, Android, iOS, Flutter, .NET, Go, PHP, Selenium, Salesforce, SAP, Kubernetes, Docker, Terraform, Tableau, Power BI, and 30+ more technologies across SDE, frontend, backend, mobile, QA, DevOps, data engineering, AI/ML, and cybersecurity domains." },
  { q: "How does the interview proxy process work?", a: "We use Chrome Remote Desktop for secure remote access and Otter.ai for real-time voice-to-text prompting. You connect with our expert via Google Meet, wear wired headphones, and the expert handles all technical and behavioral questions. Full setup details are shared 24 hours before the interview." },
  { q: "Is the service confidential?", a: "Yes, 100% confidential. All session data, interview recordings, and communication are handled with strict privacy. We never share client information or interview details with any third party." },
  { q: "How do I book a session?", a: "Simply reach out via WhatsApp at +91 96492 24523 or email proxyinterview980@gmail.com. We respond within 30 minutes and offer a free initial consultation to understand your requirements." },
  { q: "What is job support and how does it work?", a: "Job support provides daily on-the-job expert assistance — 3 hours per day at $600/month. Our dedicated expert helps with code reviews, debugging, sprint deliverables, and technology ramp-up. If you need more hours, extra days are covered automatically." },
  { q: "Do you offer services for all interview platforms?", a: "Yes. We support Zoom, Google Meet, Microsoft Teams, HackerRank, CodeSignal, CoderPad, LeetCode, and all major interview platforms. Our experts are experienced with both live coding rounds and take-home assessments." },
];
    ...
    <div style={{background:"#08090E",minHeight:"100vh",color:"#fff",overflow:"hidden"}}>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        @keyframes shimmer{0%{transform:translateX(-50%)}50%{transform:translateX(0%)}100%{transform:translateX(-50%)}}
