...
const SETUP_GUIDE = [
  { step:"01", title:"System Requirements", icon:"💻", items:["A stable internet connection (minimum 10 Mbps upload/download)","A laptop or desktop with a working webcam and microphone","Google Chrome or Brave browser (latest version)","A quiet, well-lit room with a clean background"] },
  { step:"02", title:"Software Setup", icon:"⚙️", items:["Install AnyDesk or TeamViewer for secure remote screen-sharing","Install a secondary audio routing tool (VB-Cable / Voicemeeter)","Set up a secondary device (phone or tablet) as a backup communication channel","Test your audio/video setup 30 minutes before the interview"] },
  { step:"03", title:"Before the Interview", icon:"📋", items:["Share the interview invite link, job description, and your resume with us at least 24 hours in advance","Join a 15-minute prep call with your assigned proxy expert","Confirm the interview platform (Zoom, Google Meet, Teams, HackerRank, CodeSignal, etc.)","Do a full dry run to test audio routing and screen sharing"] },
  { step:"04", title:"During the Interview", icon:"🎯", items:["Stay calm — your proxy expert handles all technical and behavioral questions","Keep your secondary device connected for real-time coordination","Do not interrupt or type during the session unless instructed","Our expert manages screen sharing, coding, and live communication seamlessly"] },
  { step:"05", title:"After the Interview", icon:"✅", items:["Receive a detailed debrief with all questions asked and answers given","Get a confidence score and feedback on interview performance","Discuss next steps — follow-up rounds, offer negotiation, or job support","All session data is handled with strict confidentiality"] },
];
